...
namespace Dat.V1.Data.Layers.MsSql {
  ...
  [Serializable] public class Connector : IDisposable {
    ...
    #region -->> MEMBERS                                                                <<--
      ...
      [NonSerialized] private SqlConnection _connection;
    ...
    #region -->> METHODS                                                                <<--
      ...
      public DataTable GetDataTable(string storedProcedure, params Object[] parameters) {
        ...
        try {
          ...
          if (data.Tables.Count == 1) result = data.Tables[0];
      ...
      public void Execute(string storedProcedure, params Object[] parameters) {
        ...
        try {
          ...
          throw new Exception("Error executing the " + storedProcedure.ToString() + " stored procedure.", ex);
        }
