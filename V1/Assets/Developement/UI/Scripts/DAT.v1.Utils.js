Dat.V1.Utils = {
    Template: {
        Init: function (options) {
            ...
            jQuery(options.Template.contents).each(function (i, v) {
                switch (v.content_type) {
                    case ".js":
                        var script = jQuery("<script>").attr("src", v);
                        script.appendTo($body);
                        break;
                    case ".css":
                        jQuery("<link>").attr("href", v).attr("rel", "stylesheet").attr("type", "text/css").appendTo($body);
                        break;
                    case ".html":
