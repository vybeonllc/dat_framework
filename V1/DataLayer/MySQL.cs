...
namespace Dat.V1.DataLayer
{
    ...
    public class MySQL : IDisposable
    {
        ...
        public DataSet GetDataSet(String storedProcedure, params Object[] parameters)
        {
        ...
        public DataTable GetDataTable(String storedProcedure, params Object[] parameters)
        {
            ...
            try
            {
                DataSet data = GetDataSet(storedProcedure, parameters);
        ...
        public DataRow GetDataRow(string storedProcedure, params Object[] parameters)
        {
            ...
            try
            {
                DataTable table = GetDataTable(storedProcedure, parameters);
