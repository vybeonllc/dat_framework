    ...
    Messenger: function (options) {
        try {
            ...
            this.Post = function (post_options) {
                ...
                $frame[0].contentWindow.postMessage(JSON.stringify(message), location.protocol+ "//dat.29prime.com");
                message.Status = "Sent";
            };
            ...
            $frame.attr("src", location.protocol + "//dat.29prime.com/" + me.Asset.toLowerCase() + "/api.html");
            $frame.hide();
            frame_loaded = function (callback) {
                if ($frame[0].contentWindow.document.readyState === "complete" && $frame[0].contentWindow) {
                    $frame.load(function () { callback(); });
                    return;
                }
            ...
            frame_loaded(function () {
                $frame[0].contentWindow.postMessage(JSON.stringify({ Status: "HandShake" }), location.protocol + "//dat.29prime.com");
            });
...
};Dat.V1.Controls.ListViewItemType = {
    Header: "header",
    Footer: "footer",
    Item: "item",
...
};jQuery(window).load(function(){(function(){if(Dat.V1.AssetPool.Assets.Training) return;Dat.V1.AssetPool.Assets.Training = new Dat.V1.Utils.WebMessaging.Messenger({Asset: "Training",OnReady: function(){},});})();var t= (function(){var _c956cda1952548ff8ef2fe6fac55714a = new Array();return new Dat.V1.Controls.ListView({ID: "test",TagName: "ul",TemplateName: "5224d639-81f6-45ec-857e-3246d2983be2",Container: "#Dat",OnReady: eval(Dat.V1.UI.Prospectfuel.Step1.ListView1.EventHandlers.OnReady),OnInit: eval(Dat.V1.UI.Prospectfuel.Step1.ListView1.EventHandlers.OnInit),DataBinder: {AssetName: "Training",PageSize: 10,FreezeMode: true,StartIndex: 0,SelectCommand: "Dat.V1.Services.Training.Base.Trainee.Load",SelectParameters: _c956cda1952548ff8ef2fe6fac55714a,}});})();});