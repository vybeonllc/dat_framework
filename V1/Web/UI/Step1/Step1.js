            ...
            return jQuery.ajax({
                ...
                success: function (response) {
                    if (response.status) {
                        ...
                        if (response.status.code.toString()[0] == 2 || response.status.code == Dat.V1.Utils.Enumerations.ReponseTypes.Busy.Code)
                            options.OnSuccess(response);
                        else if (response.status.code.toString()[0] == 3)
...
Dat.V1.Utils.WebMessaging = {
            ...
            window.addEventListener("message", function (evt) {
                ...
                if (message.Status == "Succeed")
                    ...
                    if (message.Options.OnRedirect)
                        message.Options.OnRedirect(message.Result);
                    else if (message.Result.status.message)
                        alert("You are about to leave this website because " + message.Result.status.message);
                    if (message.Result.status.target)
                        window.location = message.Result.status.target;
                }
                else
    ...
    this.SubmitElement = options.SubmitElement ? options.SubmitElement : "[name='data-submit']";
    this.DeleteElement = options.DeleteElement ? options.DeleteElement : "[name='data-delete']";
    this.OnError = options.OnError;
    ...
    this.Init = function () {
        ...
        me.DataBinder = new Dat.V1.Controls.DataBinder({
            ...
            OnCreated: function (databiner, event_arg) { if (options.DataBinder.OnCreated) options.DataBinder.OnCreated(me, event_arg); },
            OnUpdating: function (databiner, event_arg) { if (options.DataBinder.OnUpdating) options.DataBinder.OnUpdating(me, event_arg); },
            OnUpdated: function (databiner, event_arg) { if (options.DataBinder.OnUpdated) options.DataBinder.OnUpdated(me, event_arg); },
    ...
    this.DataBind = function (ondatabound) {
        me.DataBinder.OnDataBound = function () {
            ...
            me.DataItem = me.FormViewMode == Dat.V1.Controls.FormViewMode.Create ? me.DataItemSchema : me.DataBinder.ResultSet.results[0];
            ...
            var dataitem = me.DataItem;
            me.FormViewItem = new Dat.V1.Controls.FormViewItem();
            var formviewitem = me.FormViewItem
            formviewitem.ItemType = Dat.V1.Controls.FormViewItemType.Item;

            formviewitem.ItemTemplate = me.ItemTemplate;
            formviewitem.Container = me.Element;
            formviewitem.ID = Dat.V1.Utils.Element.GetUniqueID(me.ID + "_item");
            formviewitem.DataItem = dataitem;

            var element = jQuery(formviewitem.ItemTemplate.Element).clone(true);
            element.attr("id", formviewitem.ID);
            formviewitem.Element = element;
            formviewitem.Element.data("dataitem", dataitem);
            ...
            for (var field in dataitem) {
                var $fields = jQuery(formviewitem.Element.find("[data-field='" + field + "']"));
                formviewitem.Fields.push({ Name: field, Elements: $fields, DataType: $fields.length == 0 ? null : jQuery($fields[0]).attr("data-type"), Nullable: $fields.length == 0 ? null : jQuery($fields[0]).attr("data-nullable") });
                for (j = 0 ; j < $fields.length ; j++) {
                    var $field = jQuery($fields[j]);
                    var data_type = $field.attr("data-type");
                    var value = dataitem[field];
                    if (me.OnFieldBinding)
                        me.OnFieldBinding(field, value, $field, formviewitem, me);
                    ...
                    if (me.OnFieldBound)
                        me.OnFieldBound(field, value, $field, formviewitem, me);
                }
                var $commandArgs = jQuery(formviewitem.Element.find("[CommandArg='" + field + "']"));
                for (x = 0 ; x < $commandArgs.length ; x++) {
                    var $command_element = jQuery($commandArgs[x]);
                    var command_name = $command_element.attr("CommandName");
                    var value = dataitem[field];
                    $command_element.removeAttr("CommandArg").removeAttr("CommandName").data("eventarg", { FormViewItem: formviewitem, CommandName: command_name, CommandArg: value, FormView: me, Field: { Name: field, Element: $command_element } });
            ...
            formviewitem.AppendTo(me.Element);
...
};Dat.V1.Controls.FormViewItemType = {
    Header: "header",
    Footer: "footer",
    Item: "item",
    EmptyItem: "emptyitem",
    ...
    this.Update = function (DataItem) {
        ...
        Dat.V1.AssetPool.Manager.Call(me.AssetName, me.UpdateCommand, {
            ...
            OnSuccess: function (response) {
                if (me.OnUpdated)
                    me.OnUpdated(me, response.result_set.results[0]);
            },
    ...
    this.Create = function (DataItem) {
        ...
        Dat.V1.AssetPool.Manager.Call(me.AssetName, me.CreateCommand, {
            ...
            OnSuccess: function (response) {
                if (me.OnCreated)
                    me.OnCreated(me, response.result_set.results[0]);
            },
            OnError: function (state, error) {
                me.OnError(state, error);
            }
    ...
    var bind = function (callback) {
        ...
        Dat.V1.AssetPool.Manager.Call(me.AssetName, me.SelectCommand, {
            ...
            OnSuccess: function (response) {
                ...
                if (me.OnSelected)
                    me.OnSelected(me, { DataItem: response.result_set.results[0] });
                if (callback)
                    callback();
...
};jQuery(window).load(function(){Dat.V1.OnAssetPoolInitialized = function(){ Dat.V1.UI.Prospectfuel.Step1.OnLoad();(function(){var _49d861445c0d4819a220ca5cf16301b7 = new Array();var _d099e5a4ca01463183bc96689a6971bb = new Array();var _4da3da7a06134535a916d7357d7ef6d0 = new Array();var _3e60259bf06a46a598ca92a27c6cd4f6 = new Array();return new Dat.V1.Controls.FormView({ID: "Step1",TagName: "form",TemplateName: "cf82699f-5ed4-4dfb-beb4-04139c77e93b",Container: "#Step1",OnFieldBound: eval(Dat.V1.UI.Prospectfuel.Step1.FormView1.EventHandlers.OnFieldBound),OnReady: eval(Dat.V1.UI.Prospectfuel.Step1.FormView1.EventHandlers.OnReady),OnItemCommand: eval(Dat.V1.UI.Prospectfuel.Step1.FormView1.EventHandlers.OnItemCommand),OnInit: eval(Dat.V1.UI.Prospectfuel.Step1.FormView1.EventHandlers.OnInit),DataBinder: {AssetName: "Leads",PageSize: 10,FreezeMode: true,StartIndex: 0,PrimaryKey: "organization_id",SelectCommand: "Dat.V1.Services.Leads.Questionnaire.Step1.Select",UpdateCommand: "Dat.V1.Services.Leads.Questionnaire.Step1.Create",OnUpdating: eval(Dat.V1.UI.Prospectfuel.Step1.FormView1.EventHandlers.OnUpdating),OnUpdated: eval(Dat.V1.UI.Prospectfuel.Step1.FormView1.EventHandlers.OnUpdated),UpdateDataItemProperty: "step1",CreateCommand: "Dat.V1.Services.Leads.Questionnaire.Step1.Create",OnCreating: eval(Dat.V1.UI.Prospectfuel.Step1.FormView1.EventHandlers.OnCreating),OnCreated: eval(Dat.V1.UI.Prospectfuel.Step1.FormView1.EventHandlers.OnCreated),CreateDataItemProperty: "step1",}});})();(function(){var _f15765bb71f84aa9a4d65a20a7f585ac = new Array();var _f4e026a7dcf842e480f0ae768426f346 = new Array();var _5f08db73ec7645b7b7986499ab3f4590 = new Array();var _15195ca4a3544189b7b94cba0d30f0f9 = new Array();_f15765bb71f84aa9a4d65a20a7f585ac.push("2");return new Dat.V1.Controls.FormView({ID: "Step2",TagName: "form",TemplateName: "92a4fc15-cb1f-430d-b946-e462c17ae959",Container: "#Step2",OnFieldBound: eval(Dat.V1.UI.Prospectfuel.Step2.FormView1.EventHandlers.OnFieldBound),OnReady: eval(Dat.V1.UI.Prospectfuel.Step2.FormView1.EventHandlers.OnReady),OnItemCommand: eval(Dat.V1.UI.Prospectfuel.Step2.FormView1.EventHandlers.OnItemCommand),OnInit: eval(Dat.V1.UI.Prospectfuel.Step2.FormView1.EventHandlers.OnInit),DataBinder: {AssetName: "Leads",PageSize: 10,FreezeMode: true,StartIndex: 0,PrimaryKey: "organization_id",SelectCommand: "Dat.V1.Services.Leads.Questionnaire.Step2.Select",SelectParameters: _f15765bb71f84aa9a4d65a20a7f585ac,UpdateCommand: "Dat.V1.Services.Leads.Questionnaire.Step2.Create",OnUpdating: eval(Dat.V1.UI.Prospectfuel.Step2.FormView1.EventHandlers.OnUpdating),OnUpdated: eval(Dat.V1.UI.Prospectfuel.Step2.FormView1.EventHandlers.OnUpdated),UpdateDataItemProperty: "step2",CreateCommand: "Dat.V1.Services.Leads.Questionnaire.Step2.Create",OnCreating: eval(Dat.V1.UI.Prospectfuel.Step2.FormView1.EventHandlers.OnCreating),OnCreated: eval(Dat.V1.UI.Prospectfuel.Step2.FormView1.EventHandlers.OnCreated),CreateDataItemProperty: "step2",}});})();(function(){var _a108e5b38f134363a56458efdb4ee25d = new Array();var _0386bd22a67e4ad294bbbc55598c46e3 = new Array();var _e05f364b6d1b408b82ae61a2682db315 = new Array();var _21291fa0f7be4cdd848ddc99c0332c63 = new Array();_a108e5b38f134363a56458efdb4ee25d.push("2");return new Dat.V1.Controls.FormView({ID: "Step3",TagName: "form",TemplateName: "5e348511-1d82-4a84-8105-8fbb749d6b51",Container: "#Step3",OnFieldBound: eval(Dat.V1.UI.Prospectfuel.Step3.FormView1.EventHandlers.OnFieldBound),OnReady: eval(Dat.V1.UI.Prospectfuel.Step3.FormView1.EventHandlers.OnReady),OnItemCommand: eval(Dat.V1.UI.Prospectfuel.Step3.FormView1.EventHandlers.OnItemCommand),OnInit: eval(Dat.V1.UI.Prospectfuel.Step3.FormView1.EventHandlers.OnInit),DataBinder: {AssetName: "Leads",PageSize: 10,FreezeMode: true,StartIndex: 0,PrimaryKey: "organization_id",SelectCommand: "Dat.V1.Services.Leads.Questionnaire.Step3.Select",SelectParameters: _a108e5b38f134363a56458efdb4ee25d,UpdateCommand: "Dat.V1.Services.Leads.Questionnaire.Step3.Create",OnUpdating: eval(Dat.V1.UI.Prospectfuel.Step3.FormView1.EventHandlers.OnUpdating),OnUpdated: eval(Dat.V1.UI.Prospectfuel.Step3.FormView1.EventHandlers.OnUpdated),UpdateDataItemProperty: "step3",CreateCommand: "Dat.V1.Services.Leads.Questionnaire.Step3.Create",OnCreating: eval(Dat.V1.UI.Prospectfuel.Step3.FormView1.EventHandlers.OnCreating),OnCreated: eval(Dat.V1.UI.Prospectfuel.Step3.FormView1.EventHandlers.OnCreated),CreateDataItemProperty: "step3",}});})();(function(){var _e4461fb776d149619743fc2325cec3ba = new Array();var _fb74d1c9a89141c5bd2e39a4ba432400 = new Array();var _70e0b57fe7fd4b1fa1f1606bb447b5f2 = new Array();var _08031dad6f3341329141fbbc47ac1f78 = new Array();_e4461fb776d149619743fc2325cec3ba.push("2");return new Dat.V1.Controls.FormView({ID: "Step4",TagName: "form",TemplateName: "5487665f-7329-46d1-aa94-bc4d314283f2",Container: "#Step4",OnFieldBound: eval(Dat.V1.UI.Prospectfuel.Step4.FormView1.EventHandlers.OnFieldBound),OnReady: eval(Dat.V1.UI.Prospectfuel.Step4.FormView1.EventHandlers.OnReady),OnItemCommand: eval(Dat.V1.UI.Prospectfuel.Step4.FormView1.EventHandlers.OnItemCommand),OnInit: eval(Dat.V1.UI.Prospectfuel.Step4.FormView1.EventHandlers.OnInit),DataBinder: {AssetName: "Leads",PageSize: 10,FreezeMode: true,StartIndex: 0,PrimaryKey: "organization_id",SelectCommand: "Dat.V1.Services.Leads.Questionnaire.Step4.Select",SelectParameters: _e4461fb776d149619743fc2325cec3ba,UpdateCommand: "Dat.V1.Services.Leads.Questionnaire.Step4.Create",OnUpdating: eval(Dat.V1.UI.Prospectfuel.Step4.FormView1.EventHandlers.OnUpdating),OnUpdated: eval(Dat.V1.UI.Prospectfuel.Step4.FormView1.EventHandlers.OnUpdated),UpdateDataItemProperty: "step4",CreateCommand: "Dat.V1.Services.Leads.Questionnaire.Step4.Create",OnCreating: eval(Dat.V1.UI.Prospectfuel.Step4.FormView1.EventHandlers.OnCreating),OnCreated: eval(Dat.V1.UI.Prospectfuel.Step4.FormView1.EventHandlers.OnCreated),CreateDataItemProperty: "step4",}});})();(function(){var _2cf860057e2b4efe9d58ec225166a510 = new Array();var _dae620c9e45d479ba6c70287c015964b = new Array();var _95cbf63d222e40d39486e317599cdd41 = new Array();var _d4b9284804254aa2bd9853940cf5a635 = new Array();_2cf860057e2b4efe9d58ec225166a510.push("2");return new Dat.V1.Controls.FormView({ID: "Step5",TagName: "form",TemplateName: "c7c703aa-1d67-432f-9209-ca500df577f3",Container: "#Step5",OnReady: eval(Dat.V1.UI.Prospectfuel.Step5.FormView1.EventHandlers.OnReady),OnItemCommand: eval(Dat.V1.UI.Prospectfuel.Step5.FormView1.EventHandlers.OnItemCommand),OnInit: eval(Dat.V1.UI.Prospectfuel.Step5.FormView1.EventHandlers.OnInit),DataBinder: {AssetName: "Leads",PageSize: 10,FreezeMode: true,StartIndex: 0,PrimaryKey: "phone_number",SelectCommand: "Dat.V1.Services.Leads.Questionnaire.Step5.Select",SelectParameters: _2cf860057e2b4efe9d58ec225166a510,}});})();};(function(){if(Dat.V1.AssetPool.Assets.Dat) return;Dat.V1.AssetPool.Total = (Dat.V1.AssetPool.Total || 0) + 1;Dat.V1.AssetPool.Assets.Dat = new Dat.V1.Utils.WebMessaging.Messenger({Asset: "Dat",AssetUrl: "",OnReady: function(){ Dat.V1.AssetPool.Count++; if(!Dat.V1.AssetPool.AssetPoolInitialized) if(Dat.V1.AssetPool.Total == Dat.V1.AssetPool.Count) {Dat.V1.AssetPool.AssetPoolInitialized = true;Dat.V1.OnAssetPoolInitialized();}function(){}();},});})();(function(){if(Dat.V1.AssetPool.Assets.Leads) return;Dat.V1.AssetPool.Total = (Dat.V1.AssetPool.Total || 0) + 1;Dat.V1.AssetPool.Assets.Leads = new Dat.V1.Utils.WebMessaging.Messenger({Asset: "Leads",AssetUrl: "",OnReady: function(){ Dat.V1.AssetPool.Count++; if(!Dat.V1.AssetPool.AssetPoolInitialized) if(Dat.V1.AssetPool.Total == Dat.V1.AssetPool.Count) {Dat.V1.AssetPool.AssetPoolInitialized = true;Dat.V1.OnAssetPoolInitialized();}function(){}();},});})();});